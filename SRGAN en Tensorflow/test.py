...
data_directory = os.path.join(current_directory, "Dataset/chest_x-ray")
image_directory = "Chest_X-Ray_test_LR"
...
weights_directory = os.path.join(current_directory, "weights/srgan_chest_x-ray")
...
sr_path = os.path.join(current_directory, "test_results/sr_image.jpeg")
...
lr_path = os.path.join(current_directory, "test_results/lr_image.jpeg")
image_lr.save(lr_path)

hr_image_path = os.path.join(current_directory, "Dataset/chest_x-ray/Chest_X-Ray_test_LR/hr_image.jpeg")
hr_image = Image.open(hr_image_path)
new_hr_image_path = os.path.join(current_directory, "test_results/hr_image.jpeg")
